...
const T = {
  en: {
    nav_links: [["Solutions","solutions"],["MAGMASOFT®","magmasoft"],["Capabilities","capabilities"],["Process","process"],["Nexus","nexus"],["About","about"]],
    nav_contact: "Contact →",
    area_desc: {
  ...
  sv: {
    nav_links: [["Lösningar","solutions"],["MAGMASOFT®","magmasoft"],["Kompetens","capabilities"],["Process","process"],["Nexus","nexus"],["Om oss","about"]],
    nav_contact: "Kontakt →",
    area_desc: {
...
const EXPLORE_ICONS  = { solutions: "tool", magmasoft: "cpu", capabilities: "atom", process: "list-check", nexus: "apps", about: "user-circle" };
